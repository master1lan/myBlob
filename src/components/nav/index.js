...
export function Stories({ href = '/', path }) {
    if (path !== href)
        return (
            <Nav href={href}>
...
export function Lists({ href = '/', path }) {
    if (path !== href)
        return (
            <Nav href={href}>
...
export function Write({ href = '/', path }) {
    if (path !== href)
        return (
            <Nav href={href}>
