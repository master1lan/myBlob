...
//用户logo标签
export function UserLOGO({ height = '30', src, href = '/me' }) {
    src = src || `${URL}/public/userlogo/userLOGO.png`;
    return (
        <div style={{
            width: height,
            height: height,
            ...
            <Nav href={href}>
                ...
                {/* 下面自动实现了图片的懒加载 */}
                <Imagewrapper src={src} width={height} height={height} style={{ borderRadius: "50%" }} />
            </Nav>
        </div>
    )
}
